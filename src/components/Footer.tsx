...
const SOCIAL = [
  ...
  {
    label: "Facebook",
    href: "https://www.facebook.com/profile.php?id=61571271814728",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="h-4 w-4">
  ...
  {
    label: "YouTube",
    href: "https://www.youtube.com/@FabrikoInd",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="h-4 w-4">
  ...
  {
    label: "LinkedIn",
    href: "https://www.linkedin.com/company/fabriko-ind%C3%BAstria-de-m%C3%B3veis/",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="h-4 w-4">
