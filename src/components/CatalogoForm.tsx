  ...
  if (sent) {
    return (
      ...
      >
        ...
        <h3 className="font-[family-name:var(--font-playfair)] font-black text-2xl text-white mb-2">
          Catálogo enviado!
        </h3>
        <p className="text-white/50 text-sm leading-relaxed">
          Verifique seu e-mail — enviamos o link para baixar o catálogo da Fabriko.<br />
      ...
      {[
        ...
        <div key={name}>
          ...
          <input
            ...
            className="w-full border border-white/15 focus:border-[#E67A22] outline-none text-white text-sm px-4 py-3 transition-colors bg-white/5 placeholder:text-white/25"
          />
        </div>
      ))}
